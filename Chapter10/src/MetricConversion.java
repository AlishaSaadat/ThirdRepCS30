...
Program: MetricConversion.java          Last Date of this Revision: March 14/2022

Purpose: Allows user to choose between a few different types of conversions to show what 1 ___ is to converted type. 
...
public class MetricConversion {
	 ...
	 */
	//displays frame, panel, combo box, button, and text areas
	//after user chooses a conversion type and presses button, displays conversion of 1 ____ to converted type
