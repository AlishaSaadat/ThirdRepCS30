...
Program: DivisibleBy3.java          Last Date of this Revision: March 14/2022

Purpose: Takes user input and sees if integer is divisible by 3 using Modulus(%) function.
...
public class DivisibleBy3 {
	 ...
	 */
	//Creates frame, panels, text fields, and button.
	//gets input from user
	//uses % too see if there is a remainder when divided by 3.
		//if input % 3 = 0 then input is divisible and a factor
		//if input % 3 not equal to 0 then input is not divisible by 3 and not a factor
		//tells user if divisible or not
