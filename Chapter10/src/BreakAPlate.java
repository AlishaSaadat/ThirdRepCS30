...
public class BreakAPlate {
	 ...
	 */
	//Imports images from computer systems onto frame, panel, and labels. 
	//Displays main screen with no prize and no broken plates
	//Button: Picks random number from 1-3, depending on number will show corresponding images. 
	//Changes button text from "Play" to "Play again"
		//1 = 2 plates broken + splatter sticker
		//2 = 3 plates broken + tiger plush image
		//3 = troubleshooting DOES NOT CHANGE SCREEN
